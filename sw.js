const CACHE='neetpg2027-v4-2026-09-15-premium1';
const ASSETS=['./','./index.html','./assets/app.css','./assets/ui-v4.css','./assets/app.js','./assets/neetpg-timer.js','./assets/supabase-config.js','./assets/auth-sync.js','./assets/auth-provider-guard.js','./assets/ui-v4.js','./manifest.webmanifest','./data/high_yield_100/part01.json','./data/high_yield_100/part02.json','./data/high_yield_100/part03.json','./data/high_yield_100/part04.json'];
