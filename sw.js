const CACHE='neetpg2027-v11-2026-09-15-analytics1';
const ASSETS=['./','./index.html','./assets/app.css','./assets/ui-v4.css','./assets/app.js','./assets/ui-v4-core-compat.js','./assets/neetpg-timer.js','./assets/supabase-config.js','./assets/auth-sync.js','./assets/auth-provider-guard.js','./assets/ui-v4.js','./assets/ui-v4-fixes.js','./assets/exam-v9.css','./assets/exam-v9.js','./assets/phase10-taxonomy.js','./assets/phase11-analytics.js','./manifest.webmanifest','./data/high_yield_100/part01.json','./data/high_yield_100/part02.json','./data/high_yield_100/part03.json','./data/high_yield_100/part04.json'];
