...
function panel(){
  const layout=document.querySelector('#view-dashboard .v4-dashboard'),host=layout?.querySelector('#v12Planner[data-dashboard-slot="planner"]');if(!host)return false;injectStyles();host.classList.remove('hidden');
